...
import { registrationData } from "./authApi.js";
...
export const createRegForm = () => {
    ...
    modalTitle.textContent = 'Зарегистрируйтесь';
    labelName.textContent = 'Введите почту';
    labelSurname.textContent = 'Введите пароль';
    labelLastName.textContent = 'Отчество';
    addContactBtn.textContent = 'Добавить контакт';
    saveBtn.textContent = 'Регистрация';
    cancelBtn.textContent = 'Войти в существующий аккаунт';
